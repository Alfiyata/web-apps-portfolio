  ...
  <header class="bg-white fixed top-0 left-0 right-0 z-50 transition-all duration-300" :class="{ 'shadow-md': scrolled }">
    <nav class="mx-auto flex w-full items-center justify-between px-8" aria-label="Global">
      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12 lg:justify-center lg:flex-1">
        <router-link to="/" class="text-sm/6 font-semibold text-gray-900">Home</router-link>
        ...
        <router-link to="/contact" class="text-sm/6 font-semibold text-gray-900">Contact</router-link>
      </PopoverGroup>
    </nav>
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            <div class="space-y-2 py-6">
              <a href="/contact" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Home</a>
              ...
              <router-link to="/contact" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Contact</router-link>
            </div>
          </div>
        </div>
      </DialogPanel>
